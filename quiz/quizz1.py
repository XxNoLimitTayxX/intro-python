...
"Logical Operator, Comparison Operator, Assignment Operator"
# a situation where you would use each one.
 "Comparison Operator: Dog > Cat (weight)"
 "Logical Operator: True or False? Your age is over 10"
 "Mathmatic Operator: 1+1"

# 3. Describe the difference between camal case and pascal case.
 "The only diference is that the first letter of the first word is capitalized in the Pascal case unlike Camel"
...
# and use the input() function and print function to take in and print out the user's responses. 
 ...
 fullName = imput("What's your full name?")
 yourAge = imput("How old are you?")
 allergies = imput("Do you have any allergies? If so, what?")
 favoriteFood = imput("What's your favorite food?")
...
# scenario and how would you write a variable to represent this value?
 ...
 glutenAllergy =imput("Do you have a gluten allergy?")
 "You could use a boolean to determine if it's true or false."

# 9. In your own words, describe what a program is?
 "A function is a command that allows something to work through a program."
# 10. Describe the difference between a float and an integer. 
 "An interger is a whole number while a float is a number with decimals."